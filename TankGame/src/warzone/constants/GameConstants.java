...
public class GameConstants {
    ...
    public static final int HELP_MENU_SCREEN_WIDTH = 500;
    public static final int HELP_MENU_SCREEN_HEIGHT = 550;
    public static final String BUTTON_BACKGROUND_COLOR = "#3466AF";
    public static final String BUTTON_FOREGROUND_COLOR = "#FFCB05";
}
