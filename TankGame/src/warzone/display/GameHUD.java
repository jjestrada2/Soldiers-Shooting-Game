...
public class GameHUD {
    ...
    private void drawLives(Graphics2D g2) {
        ...
        int livesXOffset = ResourcesManager.getSprite(ResourcesConstants.HEALTH).getWidth();
        for(int i = 0; i < lives; i++) {
            livesXPosition += livesXOffset * i;
            g2.drawImage(ResourcesManager.getSprite(ResourcesConstants.HEALTH), livesXPosition, livesYPosition, null);
