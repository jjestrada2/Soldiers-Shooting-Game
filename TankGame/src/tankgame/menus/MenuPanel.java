...
public abstract class   MenuPanel extends JPanel {
    ...
    protected JLabel createLabel(String text, int textSize, int x, int y, int width, int height) {
        ...
        label.setBackground(Color.decode(GameScreenConstants.BUTTON_BACKGROUND_COLOR));
        label.setForeground(Color.decode(GameScreenConstants.BUTTON_FOREGROUND_COLOR));
        return label;
    }
