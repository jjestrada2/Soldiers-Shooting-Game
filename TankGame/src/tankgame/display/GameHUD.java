...
public class GameHUD {
    ...
    private void drawLives(Graphics2D g2) {
        ...
        int livesXOffset = ResourceManager.getImage(ResourceConstants.IMAGES_LIVES).getWidth();
        for(int i = 0; i < lives; i++) {
            livesXPosition += livesXOffset * i;
            g2.drawImage(ResourceManager.getImage(ResourceConstants.IMAGES_LIVES), livesXPosition, livesYPosition, null);
    ...
    private void drawHealthBar(Graphics2D g2) {
        ...
        g2.drawString( healthPoints + "/" + maxHealthPoints, x + (int)(4.2 * offset), this.y + (int)(0.9 * offset));
    }
